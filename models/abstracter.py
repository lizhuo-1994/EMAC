...
class ScoreInspector:
    ...
    def setup(self):
        ...
        if self.reduction:
            ...
            if self.mode == 'state':
                self.project_matrix = np.random.uniform(-0.1,0.1,(self.raw_state_dim,self.state_dim))
                ...
                self.project_matrix = np.random.uniform(-0.1,0.1,(self.raw_state_dim + self.action_dim,self.state_dim))
